...
<head>
    ...
    <style>
        ...
        /* #tableDetailBottom th,#tableDetailBottom td
        {
            border: 1px solid;
            padding: 8px;
            text-align: left;
...
<body>
    ...
    {{-- <div class="watermark">BON MARCHANDISE <br> ENTRÉE</div> --}}
