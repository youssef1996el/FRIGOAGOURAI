...
class MarchandiseEntreeExport implements FromCollection, WithHeadings, WithStyles
{
    protected $data;
    protected $ligne;
    ...
    public function collection()
    {
        ...
        $flattenedLigne = collect($this->ligne)->map(function ($item) {
            ...
            $qteentree = property_exists($item, 'qteentree') ? $item->qteentree : '';
